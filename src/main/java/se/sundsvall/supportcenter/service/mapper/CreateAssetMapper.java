...
public class CreateAssetMapper {
	...
	private static Map<String, Object> toDataForCreatingItem(CreateAssetRequest createAssetRequest) {
		...
		Optional.ofNullable(createAssetRequest.getModelName()).ifPresent(value -> dataMap.put(KEY_ITEM_ID, value));
		Optional.ofNullable(createAssetRequest.getDescription()).ifPresent(value -> dataMap.put(KEY_DESCRIPTION, value));
	...
	private static Map<String, Object> toDataForCreatingConfigurationItem(String id, CreateAssetRequest createAssetRequest) {
		...
		Optional.ofNullable(createAssetRequest.getSupplierStatus()).ifPresent(value -> dataMap.put(KEY_CI_STATUS, value));
