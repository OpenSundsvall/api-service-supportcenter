...
class UpdateCaseMapperTest {
	...
	@Test
	// TODO: Remove this after summer 2022. See: https://sundsvall.atlassian.net/browse/UF-2204
	// START REMOVE
	@Disabled
	// END REMOVE
	void toPobPayloadsWhenStatusIsDelivered() {
		...
		assertThat(firstResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(0).getStatusNoteType().toValue()).getMemo()).isEqualTo("Status: '" + caseStatus + "'");
		...
		// Two different notes.
		assertThat(secondResult.getMemo()).isNotNull().hasSize(2);
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue())).isNotNull();
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue()).getMemo()).isEqualTo(noteText);
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue()).getExtension()).isEqualTo(".html");
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue()).getHandleSeparators()).isTrue();
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue()).getIsValidForWeb()).isFalse();
		assertThat(secondResult.getMemo().get(NoteType.PROBLEM.toValue()).getStyle()).isEqualTo(PobMemo.StyleEnum.NUMBER_2);
		assertThat(secondResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(1).getStatusNoteType().toValue()).getMemo()).isEqualTo("Status: '" + caseStatus + "'");
		assertThat(secondResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(1).getStatusNoteType().toValue()).getExtension()).isEqualTo(".html");
		assertThat(secondResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(1).getStatusNoteType().toValue()).getHandleSeparators()).isTrue();
		assertThat(secondResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(1).getStatusNoteType().toValue()).getIsValidForWeb()).isFalse();
		assertThat(secondResult.getMemo().get(CUSTOM_STATUS_MAP.get(caseStatus).get(1).getStatusNoteType().toValue()).getStyle()).isEqualTo(PobMemo.StyleEnum.NUMBER_2);
	}
