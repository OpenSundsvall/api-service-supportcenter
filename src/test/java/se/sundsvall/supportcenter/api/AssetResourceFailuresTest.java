...
class AssetResourceFailuresTest {
	...
	void createAssetMissingBody() {
		...
		webTestClient.post().uri("/assets")
			...
			.jsonPath("$.status").isEqualTo(BAD_REQUEST.value())
			.jsonPath("$.detail").isEqualTo("Required request body is missing: public org.springframework.http.ResponseEntity<java.lang.Void> se.sundsvall.supportcenter.api.AssetResource.createAsset(java.lang.String,org.springframework.web.util.UriComponentsBuilder,se.sundsvall.supportcenter.api.model.CreateAssetRequest)");
